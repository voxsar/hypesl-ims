...
@section('content')
	<x-breadcrumb pagename="New Expense" />
		    ...
		    <div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">
						<div class="row">
						    <div class="col-md-6">
						    	<x-input name="expense_no" label="Expense No" :value="$expenses->count()+1" />
						    	<x-datetime name="date" label="Expense Date" :value="Carbon\Carbon::now()->format('Y/m/d H:i')" />
						...
						<div class="row">
						    <div class="col-md-12">
						    	<div class="card">
							    	<div class="card-header">Expense Items</div>
							    	<div class="card-body">
										<div class="row mb-4">
											<div class="col-md-3 offset-md-9">
								    			<button class="btn btn-primary btn-block add_invoice_item" type="button">Add Expense Item <i class="fa fa-plus"></i></button>
								    		</div>
								    	</div>
